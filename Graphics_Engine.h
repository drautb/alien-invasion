...
public:
	...
	bool BeginScene();
	void EndScene();
	void ClearScreen(D3DCOLOR Color=D3DCOLOR_RGBA(0,0,0,0));
	void Present();
...
public:
	...
	bool Render(float x, float y, RECT *SrcRect=NULL, D3DXVECTOR2 RotationCenter=D3DXVECTOR2(0.0f,0.0f),
				float RotAngleInRads=0.0f, float ScaleX=1.0f, float ScaleY=1.0f);
	bool Free();
